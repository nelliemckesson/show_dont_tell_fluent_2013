...
So if you take this presentation as an example, Chris lives in Seattle, I live in Boston, and we also wanted to get feedback from the whole development team.
