...
Stop thinking about publishing and Web as distinct things. There's a real opportunity to use the richness of the web publishing platform to enahnce interactivity.  redefine book
...
I can pull in his changes, rebuild with the click of a button, and presto, there's the latest version of the book.
